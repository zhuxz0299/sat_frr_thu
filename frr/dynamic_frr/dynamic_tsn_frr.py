...
def main():
    ...
    parser.add_argument('--csv_dir',default='csv_tsn', help='包含CSV文件的目录路径,默认为csv_tsn')
    ...
    manager = NetworkTopologyManager(base_tsn_container_name=args.container_tsn_prefix,base_yg_container_name=args.container_yg_prefix,base_xw_container_name=args.container_xw_prefix)
